  ...
  return (
    ...
    <nav className="nav">
      <span className="nav-block">
          <a href="#" className="nav-link underline-item">
            NEW ARRIVALS
          </a>
          <a href="#" className="nav-link underline-item">
            SHOP
      ...
      <span className="nav-block with-title">
         <p>MODNIKKY</p>
      </span>
